...
- it has near-instant sidetone. This matters once you get into serious keying
...
- this matters, because most similar tools, like VBand, just emulate USB HID keyboard packets - if you lose focus on the window, it stops working. In other words, you cannot just turn off the monitor and leave it in listen mode
